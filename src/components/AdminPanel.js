...
import { Trash, Upload, Pencil, Package } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap justify-between items-center mb-8 bg-white shadow-md p-4 rounded-lg">
        ...
        <Link
          to="/admin/pedidos"
          className="flex items-center bg-green-100 hover:bg-green-200 text-green-700 px-4 py-2 rounded-md font-semibold shadow-sm"
        >
